...
const students = computed(() => userStore.listCache[cacheKey.value] ?? [])
...
<template>
  <div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-4">
      ...
      <AppButton @click="router.push('/teacher/students/new')">+ New Student</AppButton>
    </div>
    ...
    <div v-else class="flex flex-col gap-3">
      ...
      >
        <div class="min-w-0">
          ...
          <p v-if="student.phone" class="text-xs text-gray-400 mt-0.5">{{ student.phone }}</p>
        </div>
